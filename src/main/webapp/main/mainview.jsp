    ...
    <div class="mbr-section__container">
        <div>
            <ol class="carousel-indicators" style="">
                <li data-app-prevent-settings="" data-target="#slider-63" class="active" data-slide-to="0"></li><li data-app-prevent-settings="" data-target="#slider-63" data-slide-to="1"></li><li data-app-prevent-settings="" data-target="#slider-63" data-slide-to="2"></li><li data-app-prevent-settings="" data-target="#slider-63" data-slide-to="3"></li>
            </ol>
